...
class TestBoard(unittest.TestCase):
    ...
    def test_take_BB(self):
        ...
        self.assertEqual(str(self.board.grid[to_y][to_x]), 'BB', "Target position should have the White_Bishop.")
        print("Test 1 for BB_take_piece Passed")

        # Test 2: Invalid capture (not diagonal)
        self.board.place_piece(Black_Bishop('BB'), 3, 1)
        self.board.place_piece(White_Bishop('WB'), 3, 2)
        ...
        self.board.place_piece(Black_Bishop('BB'), 6, 6)
        ...
        self.board.place_piece(Black_Bishop('BB'), 4, 4)
        ...
        self.board.place_piece(Black_Bishop('BB'), 4, 4)
        self.board.place_piece(Black_Bishop('BB'), 5, 3)
        self.board.place_piece(White_Bishop('WB'), 6, 2)
