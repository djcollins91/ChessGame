...
class TestBoard(unittest.TestCase):
    ...
    def test_take_BK(self):
        ...
        self.assertEqual(str(self.board.grid[to_y][to_x]), 'BK', "Target position should have the White_King.")
        ...
        self.assertEqual(str(self.board.grid[from_y][from_x]), 'BK', "Original position should still have the White_King.")
