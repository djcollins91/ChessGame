...
class TestBoard(unittest.TestCase):
    ...
    def test_take_BN(self):
        ...
        self.assertEqual(str(self.board.grid[to_y][to_x]), 'BN', "Target position should have the White_Knight.")
        print("Test 1 for BN_take_piece Passed")

        # Test 2: Invalid capture (not diagonal)
        self.board.place_piece(Black_Knight('BN'), 3, 1)
        self.board.place_piece(White_Knight('WN'), 5, 2)
