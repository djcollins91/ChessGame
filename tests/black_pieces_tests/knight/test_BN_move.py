...
class TestBoard(unittest.TestCase):
    ...
    def test_valid_move_forward(self):
        ...
        self.board.place_piece(Black_Knight(Black_Knight.get_piece_str()), 1, 4)
        from_x, from_y = 1, 4
        to_x, to_y = 2, 6
        ...
        self.board.place_piece(Black_Knight(Black_Knight.get_piece_str()), 2, 3)
        from_x, from_y = 2, 3
        to_x, to_y = 3, 1
        piece = self.board.grid[from_y][from_x]
        self.assertIsInstance(piece, Black_Knight)
        ...
        self.board.place_piece(Black_Knight(Black_Knight.get_piece_str()), 5, 5)
        from_x, from_y = 5, 5
        to_x, to_y = 4, 3
        piece = self.board.grid[from_y][from_x]
        self.assertIsInstance(piece, Black_Knight)
        ...
        self.board.place_piece(Black_Knight(Black_Knight.get_piece_str()), 4, 4)
        from_x, from_y = 4, 4
        to_x, to_y = 6, 5
        piece = self.board.grid[from_y][from_x]
        self.assertIsInstance(piece, Black_Knight)
        ...
        self.board.place_piece(Black_Knight(Black_Knight.get_piece_str()), 3, 3)
        from_x, from_y = 3, 3
        to_x, to_y = 5, 2
        piece = self.board.grid[from_y][from_x]
        self.assertIsInstance(piece, Black_Knight)
