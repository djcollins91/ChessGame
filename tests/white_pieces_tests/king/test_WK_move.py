...
class TestBoard(unittest.TestCase):
    ...
    def test_valid_move_forward(self):
        ...
        self.board.place_piece(White_King(White_King.get_piece_str()), 1, 4)
        from_x, from_y = 1, 4
        to_x, to_y = 2, 4
        ...
        self.board.place_piece(White_King(White_King.get_piece_str()), 0, 1)
        from_x, from_y = 0, 1
        to_x, to_y = 0, 2
        piece = self.board.grid[from_y][from_x]
        self.assertIsInstance(piece, White_King)
        ...
        self.board.place_piece(White_King(White_King.get_piece_str()), 6, 6)
        from_x, from_y = 6, 6
        to_x, to_y = 6, 5
        piece = self.board.grid[from_y][from_x]
        self.assertIsInstance(piece, White_King)
        ...
        self.board.place_piece(White_King(White_King.get_piece_str()), 4, 4)
        from_x, from_y = 4, 4
        to_x, to_y = 5, 5
        piece = self.board.grid[from_y][from_x]
        self.assertIsInstance(piece, White_King)
        ...
        self.board.place_piece(White_King(White_King.get_piece_str()), 3, 3)
        self.board.place_piece(White_King(White_King.get_piece_str()), 3, 2)
        from_x, from_y = 3, 3
        to_x, to_y = 3, 2
        piece = self.board.grid[from_y][from_x]
        self.assertIsInstance(piece, White_King)
        ...
        self.assertIsInstance(self.board.grid[from_y][from_x], White_King)
        self.assertIsInstance(self.board.grid[to_y][to_x], White_King)
        self.assertEqual(str(self.board.grid[from_y][from_x]), White_King.get_piece_str())
        self.assertEqual(str(self.board.grid[to_y][to_x]), White_King.get_piece_str())
        print("Test 6 for WK_move passed")

        # Test 7: Testing if piece can't move two spot
        self.board.place_piece(White_King(White_King.get_piece_str()), 1, 5)
        from_x, from_y = 1, 5
        to_x, to_y = 1, 7
        piece = self.board.grid[from_y][from_x]
        self.assertIsInstance(piece, White_King)
