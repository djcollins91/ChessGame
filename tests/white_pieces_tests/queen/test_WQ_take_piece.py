...
class TestBoard(unittest.TestCase):
    ...
    def test_take_BQ(self):
        ...
        self.assertEqual(str(self.board.grid[to_y][to_x]), 'WQ', "Target position should have the White_Queen.")
        print("Test 1 for WQ_take_piece Passed")
        ...
        self.assertIsNotNone(self.board.grid[to_y][to_x], "Target position should have the White_Queen after the move.")
        self.assertEqual(str(self.board.grid[to_y][to_x]), 'WQ', "Target position should have the White_Queen.")
        print("Test 2 for WQ_take_piece Passed")
        ...
        self.assertEqual(str(self.board.grid[from_y][from_x]), 'WQ', "Original position should still have the White_Queen.")
        print("Test 3 for WQ_take_piece Passed")
